...
warning&Last updated 2022-08-02. These are some highlights of the things I've made the last few years.&warning
** [[https://github.com/NixOS/nixpkgs/][nixpkgs]] (contributed, =Nix=)
...
** [[https://github.com/alvr-org/ALVR/issues?q=author%3Ackiee][ALVR]] wireless VR streaming (contributed, =C++=, ==Rust==)
...
** [[https://github.com/ckiee/snes-tello][snes-tello]] (original, =C++=, ==Rust==)
Small =C++= firmware and =Rust= driver to control a toy drone
with a physical controller instead of a phone. [[https://github.com/ckiee/snes-tello][More here]].
** [[https://github.com/ckiee/daiko][daiko]] (original, =TypeScript=)
...
** [[https://github.com/ckiee/fmouse][fmouse]] (original, =C=)
A little toy project to emulate a mouse with a keyboard easily.
** [[https://github.com/ckiee/ckiesite][ckiesite]] (original, =Rust=)
...
- Optimized compile times to <5ms for fun
** [[https://github.com/cookiecord/cookiecord][cookiecord]] (original, =TypeScript=)
...
** [[https://github.com/matrix-org/matrix-react-sdk/pull/8897][Element MSC2545]] (contributed, =TypeScript=)
Decentralized the sticker picker UI so users can send arbitrary stickers instead of a limited setting. .
** [[https://github.com/langjam/jam0003/tree/main/taf][tafokr]] (original, =Rust=, custom language)
