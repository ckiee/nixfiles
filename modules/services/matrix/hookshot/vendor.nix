# https://github.com/etu/nixconfig/blob/50771a79e3c485290c4bf6113c5183b788877e0f/hosts/vps06/services/matrix-hookshot-service.nix
# TODO: Upstream
{
  config,
  lib,
  ...
  cfg = config.services.etu--matrix-hookshot;
...
in {
  options.services.etu--matrix-hookshot = {
