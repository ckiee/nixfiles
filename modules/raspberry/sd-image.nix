##
## From /nixpkgs/nixos/modules/installer/sd-card/sd-image.nix
##
#
...
in {
  ...
  options.sdImage = {
    ...
    populateFirmwareCommands = mkOption {
      example =
        literalExample "'' cp \${pkgs.myBootLoader}/u-boot.bin firmware/ ''";
      description = ''
  ...
  config = mkIf config.cookie.raspberry.enable {
    fileSystems = {
      "/boot/firmware" = {
